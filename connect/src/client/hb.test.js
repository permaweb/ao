...
import { WalletClient } from './node/index.js'

import { createLogger } from '../logger.js'
import { processIdWith } from './hb.js'
...
test('get signature id', async () => {
   const logger = createLogger('hb')
   const fn = processIdWith({ logger, signer: WalletClient.createSigner(WALLET), HB_URL: 'http://tee-3.forward.computer' })
   const result = await fn({
    path: '/push',
    method: 'POST',
    type: 'Process',
    scheduler: "Ws0mv4ZUaHW6lNypBuR852JA3abyGXTWwIhy-z8k8TQ",
    module: "m4ICFCiqbS61xhAw5bPLKiFUd-n0R4liQbBRutCsAmw",
    device: 'process@1.0',
    'scheduler-device': 'scheduler@1.0',
    'execution-device': 'genesis-wasm@1.0',
    'push-device': 'push@1.0',
    authority: "Ws0mv4ZUaHW6lNypBuR852JA3abyGXTWwIhy-z8k8TQ",
    'scheduler-location': "Ws0mv4ZUaHW6lNypBuR852JA3abyGXTWwIhy-z8k8TQ",
    'Data-Protocol': 'ao',
    Variant: 'ao.N.1',
    data: ""
   })
