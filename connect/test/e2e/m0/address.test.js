...
test('get the operator node', async () => {
  const { getOperator } = connect({ MODE: 'mainnet', URL: 'https://relay.ao-hb.xyz', signer: createSigner(WALLET) })
  const operator = await getOperator()
  assert.equal(operator, 'yTVz5K0XU52lD9O0iHh42wgBGSXgsPcu7wEY8GqWnFY')
})
