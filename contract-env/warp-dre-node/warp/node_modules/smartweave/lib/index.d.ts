...
declare const smartweave: {
    ...
    simulateInteractWrite: typeof simulateInteractWrite;
    interactRead: typeof interactRead;
    readContract: typeof readContract;
    selectWeightedPstHolder: typeof selectWeightedPstHolder;
};
export { simulateCreateContractFromTx, simulateCreateContractFromSource, createContract, createContractFromTx, loadContract, interactWrite, interactWriteDryRun, interactWriteDryRunCustom, simulateInteractWrite, interactRead, readContract, selectWeightedPstHolder, smartweave, };
