...
function loadContract(arweave, contractID, contractSrcTXID) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        contractSrcTXID = contractSrcTXID || (0, utils_1.getTag)(contractTX, 'Contract-Src');
        const minFee = (0, utils_1.getTag)(contractTX, 'Min-Fee');
        ...
        let state;
        if ((0, utils_1.getTag)(contractTX, 'Init-State')) {
            state = (0, utils_1.getTag)(contractTX, 'Init-State');
        }
        else if ((0, utils_1.getTag)(contractTX, 'Init-State-TX')) {
            const stateTX = yield arweave.transactions.get((0, utils_1.getTag)(contractTX, 'Init-State-TX'));
...
function createContractExecutionEnvironment(arweave, contractSrc, contractId, contractOwner) {
    const returningSrc = (0, utils_1.normalizeContractSource)(contractSrc);
