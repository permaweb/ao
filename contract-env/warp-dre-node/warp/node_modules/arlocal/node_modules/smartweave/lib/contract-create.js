 ...
 */
function simulateCreateContractFromSource(arweave, wallet, initState, contractSrc, reward) {
    return __awaiter(this, void 0, void 0, function* () {
        const srcTx = yield arweave.createTransaction({ data: contractSrc, reward }, wallet);
 ...
 */
function simulateCreateContractFromTx(arweave, wallet, srcTxId, state, tags = [], target = '', winstonQty = '', reward) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 * @param initState     the contract initial state, as a JSON string.
 */
function createContract(arweave, wallet, contractSrc, initState, reward) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        const srcTx = yield arweave.createTransaction({ data: contractSrc, reward }, wallet);
        srcTx.addTag('App-Name', 'SmartWeaveContractSource');
        ...
        if (response.status === 200 || response.status === 208) {
            ...
            throw new Error(`Unable to write Contract Source: ${JSON.stringify((_a = response === null || response === void 0 ? void 0 : response.statusText) !== null && _a !== void 0 ? _a : '')}`);
        }
    });
}
 ...
 * @param winstonQty    amount of winston to send to the target, if needed.
 */
function createContractFromTx(arweave, wallet, srcTxId, state, tags = [], target = '', winstonQty = '', reward) {
    return __awaiter(this, void 0, void 0, function* () {
        let contractTX = yield arweave.createTransaction({ data: state, reward }, wallet);
        if (target && winstonQty && target.length && +winstonQty > 0) {
            contractTX = yield arweave.createTransaction({
