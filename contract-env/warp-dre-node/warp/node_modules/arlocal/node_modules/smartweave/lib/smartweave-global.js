...
class SmartWeaveGlobal {
    constructor(arweave, contract) {
        ...
        this.contracts = {
            readContractState: (contractId, height, returnValidity) => (0, contract_read_1.readContract)(arweave, contractId, height || (this._isDryRunning ? Number.POSITIVE_INFINITY : this.block.height), returnValidity),
        };
    }
    get _isDryRunning() {
