...
export const domainConfigSchema = z.object({
   ...
   * checkpoints when they are pulled from Arweave
   */
  CHECKPONT_VALIDATION_STEPS: positiveIntSchema,

  /**
   * The percentage of correct validations required before accepting a
   * state generated by fetching checkpoints from Arweave
   */
  CHECKPONT_VALIDATION_THRESH: decimalSchema,
