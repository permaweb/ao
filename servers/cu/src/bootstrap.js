...
export const createApis = async (ctx) => {
  ...
  return { metrics, stats, pendingReadStates, readState, readStateFromCheckpoint, dryRun, readResult, readResults, readCronResults, checkpointWasmMemoryCache, healthcheck }
}
