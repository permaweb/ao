...
const CONFIG_ENVS = {
  development: {
    ...
    DISABLE_PROCESS_CHECKPOINT_CREATION: process.env.DISABLE_PROCESS_CHECKPOINT_CREATION !== 'false', // disable by default
    ...
    PROCESS_MEMORY_COMPRESS: process.env.PROCESS_MEMORY_COMPRESS === 'true', // disable by default
