...
const CONFIG_ENVS = {
  development: {
    ...
    EAGER_CHECKPOINT_ACCUMULATED_GAS_THRESHOLD: process.env.EAGER_CHECKPOINT_ACCUMULATED_GAS_THRESHOLD || 300_000_000_000_000, // Amount of gas for 2 hours of continuous compute
