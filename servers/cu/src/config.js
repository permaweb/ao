...
const CONFIG_ENVS = {
  development: {
    ...
    WASM_MODULE_CACHE_MAX_SIZE: process.env.WASM_MODULE_CACHE_MAX_SIZE || 5, // 5 loaded wasm modules
    WASM_BINARY_CACHE_MAX_SIZE: process.env.WASM_BINARY_CACHE_MAX_SIZE || 5, // 5 wasm binaries
