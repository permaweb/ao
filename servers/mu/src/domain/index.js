...
import { sendMsgWith, processMsgWith, crankMsgsWith, processSpawnWith, monitorProcessWith } from './lib/main.js'
...
export const createApis = (ctx) => {
  ...
  const sendMsg = sendMsgWith({
    createDataItem,
    cacheTx: dataStoreClient.saveTxWith({ dbInstance, logger: sendMsgLogger }),
