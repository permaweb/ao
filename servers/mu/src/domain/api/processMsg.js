...
export function processMsgWith ({
  ...
  const buildTx = buildTxWith({ buildAndSign, logger, locateProcess, fetchSchedulerProcess, isWallet, getIsHyperBeamProcess, setIsHyperBeamProcess, fetchTransactionDetails })
